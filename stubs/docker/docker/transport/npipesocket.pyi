...
class NpipeSocket:
    ...
    # NotImplementedError
    def getsockopt(self, level, optname, buflen=None) -> Never: ...
    # NotImplementedError
    def ioctl(self, control, option) -> Never: ...
    # NotImplementedError
    def listen(self, backlog) -> Never: ...
    ...
    # NotImplementedError
    def setsockopt(self, level, optname, value) -> Never: ...
