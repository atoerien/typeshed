...
from typing import Literal, NamedTuple, TypedDict, TypeVar, overload, type_check_only
...
def create_ipam_pool(*args: Unused, **kwargs: Unused) -> Never: ...
@deprecated("utils.create_ipam_config has been removed. Please use a docker.types.IPAMConfig object instead.")
def create_ipam_config(*args: Unused, **kwargs: Unused) -> Never: ...
...
def create_host_config(self, *args: Unused, **kwargs: Unused) -> Never: ...
