...
def cli_option(params: _YoutubeDLOptions, command_option: str, param: str, separator: str | None = None) -> Any: ...
def cli_bool_option(
...
def cli_valueless_option(params: _YoutubeDLOptions, command_option: str, param: str, expected_value: bool = True) -> Any: ...
...
class FormatSorter:
    ...
    ydl: YoutubeDL
    def __init__(self, ydl: YoutubeDL, field_preference: _YoutubeDLOptions) -> None: ...
    def evaluate_params(self, params: _YoutubeDLOptions, sort_extractor: Collection[str]) -> None: ...
