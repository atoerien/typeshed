...
class IBM_DBEnvHandle:
    """IBM DataServer shared environment handle for 2PC"""
    def __new__(cls, *args: object, **kwargs: object) -> Self: ...
...
def alloc_env_handle() -> IBM_DBEnvHandle:
    """Allocates a shared environment handle for two-phase commit"""
    ...
...
def commit_two_phase(env_handle: IBM_DBEnvHandle, /) -> bool:
    """Two-phase commit across all connections on a shared env"""
    ...
...
def connect_coordinated(env_handle: IBM_DBEnvHandle, database: str, user: str, password: str, /) -> IBM_DBConnection:
    """Creates a coordinated connection for two-phase commit"""
    ...
...
def fetch_callproc(stmt: IBM_DBStatement, /) -> tuple[object, ...]:
    """Fetch the result set from stored procedure."""
    ...
...
def free_env_handle(env_handle: IBM_DBEnvHandle, /) -> bool:
    """Frees a shared environment handle"""
    ...
...
def rollback_two_phase(env_handle: IBM_DBEnvHandle, /) -> bool:
    """Two-phase rollback across all connections on a shared env"""
    ...
...
def set_env_attr(env_handle: IBM_DBEnvHandle, attribute: int, value: int, /) -> bool:
    """Sets an attribute on a shared environment handle"""
    ...
