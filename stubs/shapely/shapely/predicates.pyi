...
def is_geometry(geometry: None, **kwargs: Unpack[UFuncKwargs]) -> np.bool_[Literal[False]]:
    ...
    **kwargs
    ...
    ...
@overload
def is_geometry(geometry: ArrayLikeSeq[Any], **kwargs: Unpack[UFuncKwargs]) -> NDArray[np.bool_]:
    """
    Return True if the object is a geometry.
...
def is_missing(geometry: None, **kwargs: Unpack[UFuncKwargs]) -> np.bool_[Literal[True]]:
    ...
    **kwargs
    ...
    ...
@overload
def is_missing(geometry: ArrayLikeSeq[Any], **kwargs: Unpack[UFuncKwargs]) -> NDArray[np.bool_]:
    """
    Return True if the object is not a geometry (None).
...
def is_valid_input(geometry: Geometry | None, **kwargs: Unpack[UFuncKwargs]) -> np.bool_[Literal[True]]:
    ...
    **kwargs
    ...
    ...
@overload
def is_valid_input(geometry: ArrayLikeSeq[Any], **kwargs: Unpack[UFuncKwargs]) -> NDArray[np.bool_]:
    """
    Return True if the object is a geometry or None.
