...
def abs_paths() -> None:
    ...
    ...
def addpackage(sitedir: StrPath, name: StrPath, known_paths: set[str] | None) -> set[str] | None:
    """
...
def addsitedir(sitedir: str, known_paths: set[str] | None = None) -> None:
    ...
    """
    ...
def addsitepackages(known_paths: set[str], prefixes: Iterable[str] | None = None) -> set[str]:
    """Add site-packages to sys.path"""
    ...
def addusersitepackages(known_paths: set[str]) -> set[str]:
    """
...
def execsitecustomize() -> None:
    """Run custom site specific code, if available."""
    ...
def execusercustomize() -> None:
...
def removeduppaths() -> set[str]:
    """
    Remove duplicate entries from sys.path along with making them
    absolute
    """
    ...
def setcopyright() -> None:
